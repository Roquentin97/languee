...
class VocabularyRepositoryTest {
    ...
    @Test
    fun `lookup success returns mapped LookupResult`() =
        runTest {
    ...
    @Test
    fun `lookup maps deck refs in definitions`() =
        runTest {
    ...
    @Test
    fun `lookup 401 throws UnauthorizedException`() =
        runTest {
    ...
    @Test
    fun `lookup 404 returns failure with message containing 404`() =
        runTest {
            whenever(vocabularyApi.lookup(any(), anyOrNull(), anyOrNull(), anyOrNull()))
    ...
    @Test
    fun `lookup 422 returns failure`() =
        runTest {
            whenever(vocabularyApi.lookup(any(), anyOrNull(), anyOrNull(), anyOrNull()))
    ...
    @Test
    fun `lookup 502 returns failure`() =
        runTest {
            whenever(vocabularyApi.lookup(any(), anyOrNull(), anyOrNull(), anyOrNull()))
    ...
    @Test
    fun `lookup null body returns failure`() =
        runTest {
            whenever(vocabularyApi.lookup(any(), anyOrNull(), anyOrNull(), anyOrNull()))
    ...
    @Test
    fun `lookup network exception returns failure`() =
        runTest {
            whenever(vocabularyApi.lookup(any(), anyOrNull(), anyOrNull(), anyOrNull()))
    ...
    @Test
    fun `lookup returns 200 with empty definitions list`() =
        runTest {
    ...
    @Test
    fun `lookup over the word cap fails locally without calling the API`() =
        runTest {
    ...
    @Test
    fun `lookup at exactly the word cap calls the API`() =
        runTest {
    ...
    @Test
    fun `lookup 400 with INPUT_INVALID body throws LookupInputInvalidException`() =
        runTest {
    ...
    @Test
    fun `createUserDefinition success returns mapped CreatedUserDefinition`() =
        runTest {
            val dto =
            ...
            val result =
                repository.createUserDefinition(
                    text = "run into",
                    definition = "To encounter unexpectedly.",
                )
    ...
    @Test
    fun `createUserDefinition 409 throws DefinitionAlreadyExistsException`() =
        runTest {
    ...
    @Test
    fun `createUserDefinition 401 throws UnauthorizedException`() =
        runTest {
            whenever(vocabularyApi.createUserDefinition(any()))
                .thenReturn(Response.error(401, "{}".toResponseBody()))
    ...
    @Test
    fun `createUserDefinition 400 returns failure with message containing 400`() =
        runTest {
            whenever(vocabularyApi.createUserDefinition(any()))
    ...
    private fun aDefinitionDto(deckRefs: List<DeckRefDto> = emptyList()) =
    ...
    private fun aLookupResponseDto(definitions: List<EnrichedDefinitionDto> = listOf(aDefinitionDto())) =
