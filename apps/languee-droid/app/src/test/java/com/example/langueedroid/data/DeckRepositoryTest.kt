...
class DeckRepositoryTest {
    ...
    @Test
    fun `getDecks success returns mapped deck list`() =
        runTest {
    ...
    @Test
    fun `getDecks success with null body returns empty list`() =
        runTest {
    ...
    @Test
    fun `getDecks 401 throws UnauthorizedException`() =
        runTest {
    ...
    @Test
    fun `getDecks 500 throws exception with status code in message`() =
        runTest {
    ...
    @Test
    fun `getDecks network exception returns failure`() =
        runTest {
    ...
    @Test
    fun `createDeck success returns mapped deck`() =
        runTest {
    ...
    @Test
    fun `createDeck 409 throws DeckConflictException`() =
        runTest {
    ...
    @Test
    fun `createDeck 401 throws UnauthorizedException`() =
        runTest {
    ...
    @Test
    fun `createDeck null body returns failure`() =
        runTest {
