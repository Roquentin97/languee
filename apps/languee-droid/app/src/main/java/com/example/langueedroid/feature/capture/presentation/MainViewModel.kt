...
class MainViewModel
    ...
    constructor(
        ...
        val offlineQueueCount: StateFlow<Int> =
        ...
        private fun currentSelectedLanguage(): String =
            when (val current = _state.value) {
        ...
        fun onWordTokenTapped(index: Int) {
            ...
            val updatedSelection =
                ExpressionSpanSelector.onWordTapped(
